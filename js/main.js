    ...
    if(itemList) {
        ...
        const data = { 
            ...
            redirectUrl: { //should change to your response pages
                success: 'http://localhost/payment-gateway/response-pages/success.php',
                //failure: 'https://www.mechantsite.com/failure?id=5fc10b93-bdbd-4f31-b31d-4575a3785009',
                failure: 'http://localhost/payment-gateway/response-pages/failed.php',
                cancel: 'http://localhost/payment-gateway/response-pages/cancelled.php'
            },
